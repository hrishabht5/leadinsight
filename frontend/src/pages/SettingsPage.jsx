...
export default function SettingsPage() {
  ...
  function connectFacebook() {
    ...
    const url = `https://www.facebook.com/dialog/oauth?client_id=${VITE_FACEBOOK_APP_ID}&redirect_uri=${encodeURIComponent(redirect)}&scope=leads_retrieval,pages_manage_metadata,pages_show_list,business_management&response_type=code`
